...
o.write('''psql -d blackosprey -c "UPDATE avaricosa.avaricosa_%s SET huc_8_num = nhd_hu8_watersheds.huc_8_num FROM nhd_hu8_watersheds WHERE ST_Intersects(nhd_hu8_watersheds.geom, avaricosa.avaricosa_%s.geom) AND avaricosa.avaricosa_%s.huc_8_num IS NULL;"\n''' % (gtype, gtype, gtype))
o.write('''psql -d blackosprey -c "UPDATE avaricosa.avaricosa_%s SET huc_8_name = nhd_hu8_watersheds.hu_8_name FROM nhd_hu8_watersheds WHERE ST_Intersects(nhd_hu8_watersheds.geom, avaricosa.avaricosa_%s.geom) AND avaricosa.avaricosa_%s.huc_8_name IS NULL;"\n''' % (gtype, gtype, gtype))
o.close()
