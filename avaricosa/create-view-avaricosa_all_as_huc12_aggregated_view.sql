BEGIN;
DROP VIEW IF EXISTS avaricosa.avaricosa_all_as_huc12_aggregated_view CASCADE;
CREATE OR REPLACE VIEW avaricosa.avaricosa_all_as_huc12_aggregated_view AS (
    SELECT
        min(gid) AS gid,
        ...
        array_to_string(array_agg(source_geom), ',') AS source_geom,
        h.huc_12,
