...
if not len(sys.argv) == 5:
	print "Usage: huc12_tmax_zone_stats_calculator.py image zone_raster temp huc"
	print "Example: huc12_tmax_zone_stats_calculator.py /Volumes/BlackOsprey/GIS_Data/PRISM/4km/temperature/tmax/us_tmax_1895.01.tif mask_011000020106.tif tmax 011000020106"
	print
	sys.exit(1)
...
for i in range(0,out.shape[0]):
	...
	sql = "INSERT INTO prism_%s_statistics_huc12 (huc_12, prism_year, prism_month, num_pixels, mean, std_dev, max, min)  VALUES (%s,%s,%s,%s,%s)" % (temp, huc, pyear, pmonth, int(float(o[1])), ','.join(o[2:]))
	cursor.execute(sql)
