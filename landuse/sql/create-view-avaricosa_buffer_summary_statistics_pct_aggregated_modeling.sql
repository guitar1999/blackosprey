BEGIN;
DROP VIEW IF EXISTS avaricosa_buffer_summary_statistics_pct_aggregated_modeling CASCADE;
CREATE OR REPLACE VIEW avaricosa_buffer_summary_statistics_pct_aggregated_modeling AS (
    SELECT
        h.primary_key,
        num_pixels,
